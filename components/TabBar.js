        ...
        >
            <View style={{ flexDirection: 'row', backgroundColor: colors.background }}>
                {state.routes.map((route, index) => {
                    ...
                    // TabBar'dan gereksiz itemleri kaldırma        
                    if (['_sitemap', 'settings', '+not-found', 'settings/theme', 'settings/report', 'tasks/create', 'tasks/edit'].includes(route.name)) return null;
